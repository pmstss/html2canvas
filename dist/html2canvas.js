...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ElementContainer = /** @class */ (function () {
        function ElementContainer(element, styles, bounds) {
        ...
        var _loop_1 = function (childNode, nextNode) {
            ...
            if (isTextNode(childNode) && childNode.data.trim().length > 0) {
                ...
                */
                ...
                var styles_1 = new CSSParsedDeclaration(window.getComputedStyle(node, null));
                /*
                 ...
                 */
                styles_1.wordBreak = WORD_BREAK.NORMAL;
                /*
                ...
                (_a = parent.elements).push.apply(_a, textNodes.map(function (n) {
                    ...
                    var bounds = Bounds.fromClientRect(range_1.getBoundingClientRect());
                    var auxTextContainer = new ElementContainer(
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    null, styles_1, bounds);
                    auxTextContainer.textNodes.push(new TextContainer(n, styles_1, [new TextBounds(getNormalizedText(n), bounds)]));
    ...
    var isAnchorElement = function (node) { return node.tagName === 'A'; };
    ...
    */
    ...
    var CanvasRenderer = /** @class */ (function () {
                            ...
                            styles.textDecorationLine.forEach(function (textDecorationLine) {
                                switch (textDecorationLine) {
                                    ...
                                    case 3 /* LINE_THROUGH */:
                                        ...
                                        var middle = Math.floor(text.bounds.height / 2) + 1;
        ...
        CanvasRenderer.prototype.renderReplacedElement = function (container, _curves, image) {
    ...
    var renderElement = function (element, opts) { return __awaiter(void 0, void 0, void 0, function () {
        var ownerDocument, defaultView, instanceName, _a, width, height, left, top, defaultResourceOptions, resourceOptions, defaultOptions, options, windowBounds, clonedElement, container, documentCloner, documentBackgroundColor, bodyBackgroundColor, bgColor, defaultBackgroundColor, backgroundColor, renderOptions, canvas, renderer, root, renderer;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    container = null;
                    if (!!options.cloneDisabled) return [3 /*break*/, 2];
